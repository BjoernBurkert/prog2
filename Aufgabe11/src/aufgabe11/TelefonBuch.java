...
public class TelefonBuch {
    ...
    public List<String> prefixSearch(String s) {
        List<String> gefundeneEintraege = new LinkedList<String>();
        for (Entry<String,String> eintrag : telBuch.entrySet()) {
        	if (eintrag.getKey().startsWith(s)) {
        		gefundeneEintraege.add(eintrag.getKey() + " " + eintrag.getValue());
        	}
        }
        ...
        try {
            ...
            while ((line = in.readLine()) != null) {
                ...
                if (sf.length == 2) {
                	...
                	//System.out.println(sf[0] + "" + sf[1] + "" + sf[2]);
    ...
    public static void main(String[] args)
        ...
        telBuch.read(new File("C:\\Users\\Björn\\workspace\\Aufgabe11\\src\\aufgabe11\\TelBuchMit420Namen.txt"));
